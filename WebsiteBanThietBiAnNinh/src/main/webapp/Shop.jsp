            ...
            <section>
              ...
              <section class="mb-4">
                ...
                <div class="md-form md-outline mt-0 d-flex justify-content-between align-items-center">
                  <input oninput="searchByName(this)" value="${txtS}" name="txt" type="text" class="form-control mb-0" placeholder="Nhập từ khóa">
...
<c:forEach items="${listP}" var="o">
  ...
  <script>
    ...
    function load(cateid){
    	 $.ajax({
             url: "/WebsiteBanThietBiAnNinh/categoryShop",
    ...
    function searchByName(param){
        ...
        $.ajax({
            url: "/WebsiteBanThietBiAnNinh/searchAjaxShop",
            type: "get", //send it through get method
            data: {
                txt: txtSearch
            },
    ...
    function searchByPriceMinToMax(){
        ...
        $.ajax({
            url: "/WebsiteBanThietBiAnNinh/searchAjaxPriceMinToMax",
            type: "get", //send it through get method
            data: {
                priceMin: numMin,
                priceMax: numMax
    ...
    function searchByPriceUnder100(){
        $.ajax({
            url: "/WebsiteBanThietBiAnNinh/searchAjaxPriceUnder100Shop",
            type: "get", //send it through get method
            data: {
    ...
    function searchByPrice100To200(){
        $.ajax({
            url: "/WebsiteBanThietBiAnNinh/searchAjaxPrice100To200Shop",
            type: "get", //send it through get method
            data: {
    ...
    function searchByPriceAbove200(){
        $.ajax({
            url: "/WebsiteBanThietBiAnNinh/searchAjaxPriceAbove200Shop",
            type: "get", //send it through get method
            data: {
